...
const Activity = () => {
  return (
    <section className='relative w-full h-full bg-primary-400 rounded-t-3xl p-4'>
      <h1 className='flex items-center justify-center font-playfair font-bold text-6xl md:text-7xl text-center md:text-left text-secondary pt-12'>THE PROJECTS.</h1>
      <Swiper
        spaceBetween={30}
        centeredSlides={true}
        pagination={{
        ...
        className={`swiper-pagination-bullets-active`}
      >
        <SwiperSlide className='p-8 md:px-24 md:py-8 2xl:px-36 2xl:py-12'>
          <div className='w-full h-full p-4 md:py-24 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-12'>
            <div className='col-span-1 flex flex-col'>
              <h1 className='font-montserrat font-bold opacity-90 text-4xl md:text-6xl text-secondary'>Corn Seed Projects.</h1>
              <p className='p-0 pt-6 md:py-8 md:pr-12 font-montserrat text-sm md:text-lg text-justify text-secondary'>
            ...
            <div className='col-span-1 relative h-full w-full'>
              ...
              className='w-full h-full'>
                <SwiperSlide className='p-4 md:p-8'>
                  <Image width={960} height={540} priority src='/Assets/Images/Activity/corn1.jpg' alt='Processing Unit' className='w-[540px] h-96 object-cover'/>
                </SwiperSlide>
                <SwiperSlide className='p-4 md:p-8'>
        ...
        <SwiperSlide className='p-8 md:px-24 md:py-8 2xl:px-36 2xl:py-12'>
          <div className='w-full h-full p-4 md:py-24 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-12'>
            <div className='col-span-1 flex flex-col'>
              <h1 className='font-montserrat font-bold opacity-90 text-4xl md:text-6xl text-secondary'>Vegetable Seed Projects.</h1>
              <p className='p-0 pt-6 md:py-8 md:pr-12 font-montserrat text-sm md:text-lg text-justify text-secondary'>
            ...
            <div className='col-span-1 relative h-full w-full'>
              ...
              className='w-full h-full'>
                <SwiperSlide className='p-4 md:p-8'>
                  <Image width={960} height={540} priority src='/Assets/Images/Activity/veg1.jpg' alt='Processing Unit' className='w-[540px] h-96 object-cover'/>
                </SwiperSlide>
                <SwiperSlide className='p-4 md:p-8'>
        ...
        <SwiperSlide className='p-8 md:px-24 md:py-8 2xl:px-36 2xl:py-12'>
          <div className='w-full h-full p-4 md:py-24 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-12'>
            ...
            <div className='col-span-1 relative h-full w-full'>
              ...
              className='w-full h-full'>
                <SwiperSlide className='p-4 md:p-8'>
                  <Image width={960} height={540} priority src='/Assets/Images/Activity/processing1.jpg' alt='Processing Unit' className='w-[540px] h-96 object-cover'/>
                </SwiperSlide>
                <SwiperSlide className='p-4 md:p-8'>
