    ...
    <section>
      ...
      <div className='w-full h-full p-0 md:pt-48 md:px-36 md:py-12 flex items-center'>
        ...
        <div className='w-1/2 h-auto hidden md:flex items-center justify-center'>
          <img src="../Assets/Images/winmar3.png" alt="Vision Mission Page Hero Image" className='w-1/2 h-1/2 xl:w-3/4 xl:h-3/4 object-cover' />
        </div>
        {/* Mission Desc */}
      ...
      <div className='w-full h-full p-0 md:pt-48 md:px-36 md:py-12 flex items-center'>
        ...
        <div className='md:w-1/2 h-auto hidden md:flex items-center justify-center'>
          <img src="../Assets/Images/winmar4.png" alt="Vision Mission Page Hero Image" className='w-1/2 h-1/2 xl:w-3/4 xl:h-3/4 object-cover' />
        </div>
        {/* Vission Desc */}
