        ...
        <div className='col-span-1 p-12 md:p-24 text-primary-400'>
          ...
          <div>
            ...
            <div className='flex items-center justify-start mb-6'>
              <h1 className='w-4 h-4 md:w-12 md:h-12 flex justify-center items-center border border-primary-400 bg-primary-400 text-white rounded-full font-playfair font-bold text-md md:text-xl p-4 md:p-6'>3</h1>
            ...
            <div className='flex items-center justify-start'>
              <h1 className='w-4 h-4 md:w-12 md:h-12 flex justify-center items-center border border-primary-400 bg-primary-400 text-white rounded-full font-playfair font-bold text-md md:text-xl p-4 md:p-6'>4</h1>
